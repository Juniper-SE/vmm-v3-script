...
iface eth0 inet static
    address 172.16.211.${ip2}/31
    mtu 1500
iface eth0 inet6 static
    address fc00:dead:beef:a211::${ip2}/127
auto eth1
iface eth1 inet static
    address 172.16.22${i}.1/24
    mtu 1500
iface eth1 inet6 static
    address fc00:dead:beef:a22${i}::1/64
EOF
...
router bgp 420000100${i}
 ...
 neighbor 172.16.211.${ip1} remote-as 4200000001
 neighbor fc00:dead:beef:a211::${ip1} remote-as 4200000001
 !
 address-family ipv4 unicast
  network 172.16.22${i}.0/24
 exit-address-family
 !
 address-family ipv6 unicast
  network fc00:dead:beef:a22${i}::/64
  neighbor fc00:dead:beef:a211::${ip1} activate
 exit-address-family
exit
EOF
