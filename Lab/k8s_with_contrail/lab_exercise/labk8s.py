...
# install vnc_api : pip install contrail-api-client
...
def del_ipam(d1):
	...
	if ipam_info:
		href=ipam_info['href']
		ipam1=requests.get(href).json()
		project_href = ipam1['network-ipam']['parent_href']
		print("deleting network ipam {}".format(href))
		r=requests.delete(href)
		print("result ",r)	
		print("deleting project {}".format(project_href))
		r=requests.delete(project_href)
		print("result ",r)	
	else:
